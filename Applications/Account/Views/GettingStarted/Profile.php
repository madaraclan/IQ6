...
<div class="BoxContentBordered GettingStarted">
            ...
            <div class="row">
                ...
                <div class="inputRow">
                    ...
                    <span class="inputField">
                        ...
                        <br /><br />
                        <input type="text" name="relationInput" size="60" id="relationInput" autocomplete="off" style="<?php echo ($RelationType != 1 ? 'display:inline;' : 'display:none;'); ?> " value="<?php echo $RelationURToUName; ?>" />
    ...
    <div id="profileItemContent" >
        ...
        <div class="tips">
            Filling in your profile information will help people find you on Educeus. For example, you'll be more likely to turn up in a Educeus search if you've added your location or your real name.
        </div>
    </div>
