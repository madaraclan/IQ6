    ...
    <div class="LeftColumn" >
        <div id="Materials">
            ...
            <ul class="TitleDescriptionList">
                ...
                <li>
                    <a href="<?php $URI->WriteURI('App=Class&Com=Material&Act=DetailSubject&Param='.$scheduleItem->SUID); ?>" class="Title"><?php echo $scheduleItem->SCCode;?> - <?php echo $scheduleItem->SName;?></a>
        ...
        <div id="GradesBottom">
            ...
            <div class="LeftSide">
                <div class="HeaderDescription">
                    ...
                    <a class="Right" href="<?php $URI->WriteURI('App=Class&Com=Material&Act=CompleteGrade'); ?>">see complete grades &raquo;</a>
                </div>
