...
<?php
    ...
    foreach($schedule as $scheduleItem)
    {
        ...
        ?>
            <li>
                    <span class="Title"><a href="<?php $URI->WriteURI('App=Class&Com=MaterialGuardian&Act=DetailSubject&Param='.$studentData->STCode.'/'.$scheduleItem->SUID); ?>"><?php echo $scheduleItem->SName; ?></a></span>
