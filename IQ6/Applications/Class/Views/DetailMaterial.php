<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#itemMaterial").change(function(){
            ...
            document.location = "<?php $URI->WriteURI('App=Class&Com=Material&Act=DetailSubject'); ?>"+tmp;
        });
    });
</script>
<!--Content Two Column-->
    ...
    <div class="LeftColumn" >
        ...
        <div id="Materials">
            ...
            <div class="SimpleBreadCrumb">
                ...
                <a href="<?php URI::WriteURI('App=Class&Com=Material')?>">Materials</a>
                <span class="Separator">&raquo;</span>
                            ...
                            <table class="tabulatedData" width="100%" cellpadding="4" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php echo $class?>>
                                        ...
                                        <td><a href="<?php $URI->WriteURI('App=Class&Com=Material&Act=MPDetail&Param='.$itemMP->MPID); ?>"><?php echo $itemMP->SubjectTitle;?></a></td>
                                        <td align="center"><?php $tssdate = strtotime($itemMP->TSSDate); echo date('d-m-Y',$tssdate);  ?></td>
                                        <td align="center"><a class="Icon16 iconDownload16" href="<?php $URI->WriteURI('App=Class&Com=Material&Act=DownloadMaterial&Param='.$itemMP->MPID); ?>"></a></td>
                                    </tr>
                                    <?php
                                    }
                                    /*
                            ...
                            <table class="tabulatedData" width="100%" cellpadding="4" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php echo $class?>>
                                        ...
                                        <td><a href="<?php $URI->WriteURI('App=Class&Com=Material&Act=MPDetail&Param='.$itemAM->MPID); ?>"><?php echo $itemAM->SubjectTitle;?></a></td>
                                        <td align="center"><?php $tssdate = strtotime($itemAM->TSSDate); echo date('d-m-Y',$tssdate);  ?></td>
                                        <td align="center"><a class="Icon16 iconDownload16" href="<?php $URI->WriteURI('App=Class&Com=Material&Act=DownloadAdditionalMaterial&Param='.$itemAM->AMID); ?>"></a></td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
                                            ...
                                            <tr <?php echo $class?>>
                                                ...
                                                <td align="center">
                                                    <div class="Left" style="margin-left: 10px">
                                                        <a class="Icon16 iconDownload16 Left" href="<?php $URI->WriteURI('App=Class&Com=Material&Act=DownloadTask&Param='.$taskItem->TID); ?>"></a>
                                                        <span class="Left">&nbsp;</span>
                                                        <a class="Icon16 iconUpload16 Left" href="<?php $URI->WriteURI('App=Class&Com=Material&Act=UploadTaskPage&Param='.$taskItem->TID); ?>"></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php
    ...
    <div class="RightColumn">
        ...
        <div class="BoxWidget">
            <div class="HeaderDescription">
                ...
                <a href="<?php $URI->WriteURI('App=Class&Com=Material&Act=CompleteSchedule'); ?>" class="Right">see complete schedule &raquo;</a>
            </div>
            <div class="ClearFix"></div>
...
<?php
    ...
    foreach($nextSchedule as $nextScheduleItem)
    {
        ?>
            <li>
                    <span class="Title"><a href="<?php $URI->WriteURI('App=Class&Com=Material&Act=DetailSubject&Param='.$nextScheduleItem->SUID); ?>"><?php echo $nextScheduleItem->SName; ?></a></span>
