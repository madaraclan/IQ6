...
<div id="SubNavigation">
    <div class="ContentWrapper">
        <div class="listSubNavigation">
            ...
            <a class="current" href=""><span class="Icon16 IconFriends16"></span></a>
        </div>
                ...
                <form method="post" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="inputField">
                                ...
                                <div class="DetailList" style="display:none; margin: -21px 0 0 1px; height: 13px"><a href="#" id="RemoveList"></a></div>
                                <ul class="ListAutoComplete ListCurrentHomeTown" id="ListCurrentHomeTown" style="display:none; padding: 0; margin: 0 0 0 1; ">
                                </ul>
                ...
                <div id="DetailProfile">
                    ...
                    <div class="tabInformation">
                        <ul class="tabInformationList">
                            <li><a class="current" href="<?php $URI->WriteURI('App=Account&Com=FindFriends&Act=Search'); ?>" style="cursor:pointer;">Cari Teman</a></li>
                             <li><a href="<?php $URI->WriteURI('App=Account&Com=Friends'); ?>" style="cursor:pointer;">Teman kamu</a></li>
                       	</ul>
                        <div class="ClearFix"></div>
                    </div>
                    ...
                    <div id="posts" class="tabsItemInformation">
                         <form method="post" action="" style="padding:10px;">
		                    <input type="text" id="SearchInput" name="quickFind" value="" autocomplete="off" />
		                   	<input type="submit" id="SearchInputButton" name="quickFindButton" value="Search" />
		                </form>
		                
		                <span class="l"></span>
		                
		                 <div class="FindFriendsListContainer">
		                <ul class="FindFriendsList" id="FindFriendsList">
		                 <?php echo $ResultFriends; ?>
		                </ul>
		                </div>
...
$(function(){
	...
	var Educeus_Profile = (function(){
		...
		var SearchInputButton = $('#SearchInputButton');
		...
		var EventHandler = function(){
			...
			SearchInputButton.bind('click', function(e){
				e.preventDefault();
				var el = $(this);
				...
				$('.l').html('Loading...');
					...
					request = $.post('<?php echo $URI->WriteURI('App=Account&Com=FindFriends&Act=SearchFriends') ?>', DataRequest, function(res){
						if (res.status){
						$('#FindFriendsList').html(res.result);
						}
...
$(function(){
	...
	var Educeus_Account = (function(){
		...
		var friendsList = $('#FindFriendsList');
